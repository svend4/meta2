...
Модули:
    ...
    path_plan_utils     — утилиты планирования путей и последовательностей сборки
                          (PathPlanConfig, PathPlanEntry,
                          PathPlanSummary, make_path_entry,
                          entries_from_path_results,
                          summarise_path_entries, filter_found_paths,
                          filter_not_found_paths,
                          filter_path_by_cost_range,
                          filter_path_by_max_hops,
                          top_k_shortest_paths, cheapest_path_entry,
                          path_cost_stats, compare_path_summaries,
                          batch_summarise_path_entries,
                          AssemblyPlanConfig, AssemblyPlanEntry,
                          AssemblyPlanSummary,
    ...
    orient_skew_utils   — утилиты ориентационного анализа и коррекции наклона
                          (OrientMatchConfig, OrientMatchEntry,
                          OrientMatchSummary, make_orient_match_entry,
                          ...
                          best_orient_match_entry, orient_match_stats,
                          compare_orient_summaries,
                          batch_summarise_orient_match_entries,
                          SkewCorrConfig, SkewCorrEntry,
                          SkewCorrSummary, make_skew_corr_entry,
                          summarise_skew_corr_entries,
                          filter_high_confidence_skew,
                          filter_skew_by_method,
                          filter_skew_by_angle_range,
                          top_k_skew_entries, best_skew_entry,
                          skew_corr_stats, compare_skew_summaries,
                          batch_summarise_skew_corr_entries)
    event_affine_utils  — утилиты журналирования событий и аффинного сопоставления
                          (EventRecordConfig, EventRecordEntry,
                          EventRecordSummary, make_event_record_entry,
                          summarise_event_record_entries,
                          filter_error_events, filter_events_by_level,
                          filter_events_by_name, filter_events_by_time_range,
                          top_k_recent_events, latest_event_entry,
                          event_record_stats, compare_event_summaries,
                          batch_summarise_event_record_entries,
                          AffineMatchConfig, AffineMatchEntry,
                          AffineMatchSummary, make_affine_match_entry,
                          ...
                          best_affine_match_entry, affine_match_stats,
                          compare_affine_summaries,
                          batch_summarise_affine_match_entries)
    seq_gap_utils       — утилиты результатов последовательности фрагментов и зазоров
                          (SequenceScoreConfig, SequenceScoreEntry,
                          SequenceScoreSummary, make_sequence_score_entry,
                          summarise_sequence_score_entries,
                          filter_full_sequences,
                          filter_sequence_by_min_score,
                          filter_sequence_by_algorithm,
                          top_k_sequence_entries, best_sequence_entry,
                          sequence_score_stats, compare_sequence_summaries,
                          batch_summarise_sequence_score_entries,
                          GapScoreConfig, GapScoreEntry,
                          GapScoreSummary, make_gap_score_entry,
                          summarise_gap_score_entries,
                          filter_overlapping_gaps, filter_gap_by_category,
                          filter_gap_by_max_distance, top_k_closest_gaps,
                          best_gap_entry, gap_score_stats,
                          compare_gap_summaries,
                          batch_summarise_gap_score_entries)
    color_edge_export_utils — утилиты анализа цветового сопоставления, детекции краёв
                          и экспорта (ColorMatchAnalysisConfig,
                          ColorMatchAnalysisEntry, ColorMatchAnalysisSummary,
    ...
    rotation_hist_utils — утилиты анализа поворотов и гистограммных расстояний
                          (RotationAnalysisConfig, RotationAnalysisEntry,
                          RotationAnalysisSummary, make_rotation_analysis_entry,
                          summarise_rotation_analysis,
                          filter_rotation_by_confidence,
                          filter_rotation_by_method,
                          filter_rotation_by_angle_range,
                          top_k_rotation_entries, best_rotation_entry,
                          rotation_angle_stats, compare_rotation_summaries,
                          batch_summarise_rotation_analysis,
                          HistogramDistanceConfig, HistogramDistanceEntry,
    ...
    ranking_layout_utils — утилиты анализа глобального ранжирования и компоновки
                          (GlobalRankingConfig, GlobalRankingEntry,
                          GlobalRankingSummary, make_global_ranking_entry,
                          summarise_global_ranking_entries,
                          filter_ranking_by_min_score,
                          filter_ranking_by_fragment,
                          filter_ranking_by_top_k,
                          top_k_ranking_entries, best_ranking_entry,
                          ranking_score_stats,
                          compare_global_ranking_summaries,
                          batch_summarise_global_ranking_entries,
                          LayoutScoringConfig, LayoutScoringEntry,
                          LayoutScoringSummary, make_layout_scoring_entry,
                          summarise_layout_scoring_entries,
                          filter_layout_by_min_score,
                          filter_layout_by_quality,
                          filter_layout_by_max_overlap,
                          top_k_layout_entries, best_layout_entry,
                          layout_score_stats,
...
from .event_affine_utils import (
    EventRecordConfig,
    EventRecordEntry,
    EventRecordSummary,
...
from .color_edge_export_utils import (
...
from .rotation_hist_utils import (
...
from .ranking_layout_utils import (
    GlobalRankingConfig,
    GlobalRankingEntry,
...
__all__ = [
    ...
    "compare_rank_summaries",
    "batch_summarise_rank_results",
    # Ориентационный анализ и коррекция наклона
    "OrientMatchConfig",
    "OrientMatchEntry",
    "OrientMatchSummary",
    "make_orient_match_entry",
    ...
    "compare_skew_summaries",
    "batch_summarise_skew_corr_entries",
    # Планирование путей и последовательностей сборки
    "PathPlanConfig",
    "PathPlanEntry",
    "PathPlanSummary",
    "make_path_entry",
    ...
    "compare_assembly_plan_summaries",
    "batch_summarise_assembly_plans",
    # Журналирование событий и аффинное сопоставление
    "EventRecordConfig",
    "EventRecordEntry",
    "EventRecordSummary",
    "make_event_record_entry",
    ...
    "compare_affine_summaries",
    "batch_summarise_affine_match_entries",
    # Результаты последовательности фрагментов и зазоров
    "SequenceScoreConfig",
    "SequenceScoreEntry",
    "SequenceScoreSummary",
    "make_sequence_score_entry",
    ...
    "compare_gap_summaries",
    "batch_summarise_gap_score_entries",
    # Анализ цветового сопоставления и детекции краёв
    "ColorMatchAnalysisConfig",
    "ColorMatchAnalysisEntry",
    "ColorMatchAnalysisSummary",
    "make_color_match_analysis_entry",
    ...
    "compare_edge_detection_summaries",
    "batch_summarise_edge_detection_entries",
    # Анализ поворотов и гистограммных расстояний
    "RotationAnalysisConfig",
    "RotationAnalysisEntry",
    "RotationAnalysisSummary",
    "make_rotation_analysis_entry",
    ...
    "compare_histogram_distance_summaries",
    "batch_summarise_histogram_distance_entries",
    # Анализ глобального ранжирования и компоновки
    "GlobalRankingConfig",
    "GlobalRankingEntry",
    "GlobalRankingSummary",
    "make_global_ranking_entry",
